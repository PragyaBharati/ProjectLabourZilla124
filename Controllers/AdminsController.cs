...
namespace LabourZillaZoneee.Controllers
{
    public class AdminsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("LoginId,AdminName,Apassword,RoleA")] Admin admin)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("LoginId,AdminName,Apassword,RoleA")] Admin admin)
        {
            if (id != admin.LoginId)
            {
                return NotFound();
